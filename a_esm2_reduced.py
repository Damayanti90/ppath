...
df = pd.read_csv(r"consolidated_esm2_embeddings.txt", sep="`", header=None)
...
fp=open(r"reduced_consolidated_embeddings_esm2_PCA.txt","w")
...
fs=open(r"reduced_consolidated_embeddings_esm2_PCA.txt","r")
for line in fs:
    count+=1
    if count<=10:
       print(line)
...
symb="`"
fet_lst=[]
#fs=open(r"reduced_consolidated_fet_AE_1.txt","w")
fs=open(r"reduced_consolidated_embeddings_esm2_AE.txt","w")
...
df.to_csv("optuna_trials_log_esm2_AE.csv", index=False)
...
fs=open(r"reduced_consolidated_embeddings_esm2_AE.txt","r")
for line in fs:
    count+=1
    x=line.split("`")
    l.append(len(x))
...
ft=open(r"reduced_consolidated_embeddings_esm2_MHSA.txt","w")
...
df = study.trials_dataframe()
df.to_csv("optuna_trials_log_esm2_MHSA.csv", index=False)
...
df = pd.read_csv(r"reduced_consolidated_embeddings_esm2_MHSA.txt", sep="`", header=None)
#df = pd.read_csv(r"consolidated_fet.txt", sep="`", header=None)
x = df.iloc[:, 1:-1].values
...
count=0
#fp=open(r"reduced_consolidated_fet_PCA_1.txt","w")
fp=open(r"reduced_consolidated_embeddings_esm2_MHSA_PCA.txt","w")
...
fs=open(r"reduced_consolidated_embeddings_esm2_MHSA_PCA.txt","r")
for line in fs:
    count+=1
    if count<=10:
       print(line)
...
fet_lst=[]
#fs=open(r"reduced_consolidated_fet_AE_1.txt","w")
fs=open(r"reduced_consolidated_embeddings_esm2_MHSA_AE.txt","w")
for id,line in zip(ids,compr):
    count+=1
    #if count<=10:
       #print(len(line),line[:5],line[2])
...
df = study.trials_dataframe()
df.to_csv("optuna_trials_log_esm2_MHSA_AE.csv", index=False)
